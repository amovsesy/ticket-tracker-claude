...
<div class="min-h-screen bg-[#f6f6f8]">
	...
	<div class="space-y-6">
		<section>
			...
			<p class="mb-2">
				Ticket Price Insights ("we," "our," or "us") is committed to protecting your privacy. This
				Privacy Policy explains how we collect, use, disclose, and safeguard your information when
				you use our event tracking service.
			</p>
			<p>
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Information We Collect</h2>
			<p class="mb-2">We may collect the following types of information:</p>
			<ul class="ml-6 list-disc space-y-2">
				<li>
					<span class="font-medium">Personal Information:</span> Email address, name, and contact information
					you provide when creating an account.
				</li>
				<li>
					<span class="font-medium">Event Data:</span> Information about events you choose to track, including
					URLs, section selections, and price thresholds.
				</li>
				<li>
					<span class="font-medium">Usage Data:</span> Information about how you use our service, including
					log data, device information, and analytics.
				</li>
			</ul>
		</section>

		<section>
			<h2 class="mb-3 text-xl font-semibold">How We Use Your Information</h2>
			<p class="mb-2">We use the information we collect to:</p>
			<ul class="ml-6 list-disc space-y-2">
				<li>Provide, maintain, and improve our services</li>
				<li>Process and track the events you've selected</li>
				<li>Send notifications about price changes and event updates</li>
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Data Sharing and Disclosure</h2>
			<p>
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Data Security</h2>
			<p>
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Your Rights</h2>
			<p class="mb-2">
		...
		<section>
			<h2 class="mb-3 text-xl font-semibold">Changes to This Privacy Policy</h2>
			<p>
